...
4. [特定のプロジェクトまたは特定のユーザーに読み取り/書き込みを許可](https://docs.nhncloud.com/ko/Storage/Object%20Storage/ko/acl-guide/#role-based-access-allow-rw-project-or-user)ドキュメントを参照して、NHN Cloud Object StorageコンソールでAI EasyMakerシステムアカウントに必要な読み取り及び書き込み許可権限を追加します。
